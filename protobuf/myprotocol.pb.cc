...
std::string Game_getProp_Request::GetTypeName() const {
...
std::string Game_prop_Response::GetTypeName() const {
...
std::string UDP_INFO_REQ::GetTypeName() const {
...
std::string UDP_INFO_RES::GetTypeName() const {
