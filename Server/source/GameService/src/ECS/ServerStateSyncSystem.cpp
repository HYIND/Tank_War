...
ServerStateSyncSystem::ServerStateSyncSystem()
{
...
void ServerStateSyncSystem::postUpdate(float dt)
{
...
GameState &ServerStateSyncSystem::GetGameState()
{
	return _gamestate_tripbuffer->acquireReadBuffer();
}

void ServerStateSyncSystem::SetSyncFps(float fps)
{
	_update_fps = fps;
...
float ServerStateSyncSystem::GetSyncFps()
{
	return _update_fps;
}

void ServerStateSyncSystem::handleSyncTank(GameState &allstate, Entity entity)
{
	auto &world = getWorld();
...
void ServerStateSyncSystem::handleSyncBullet(GameState &allstate, Entity entity)
{
	auto &world = getWorld();
...
void ServerStateSyncSystem::handleSyncProp(GameState &allstate, Entity entity)
{
	auto &world = getWorld();
...
void ServerStateSyncSystem::handleSyncWall(GameState &allstate, Entity entity)
{
	auto &world = getWorld();
