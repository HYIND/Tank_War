...
namespace GameStateDef
{
    ...
    struct RoomMemeber
    {
        UserWeakPtr userweak; // 用户弱引用
        std::string name;
        MemberStatus status;
    };

    struct GameServiceHandle
    {
        std::string service_id;
        std::string game_id;
        NetworkEndpoint service_stub_endpoint;
        NetworkEndpoint service_endpoint;
    };
    ...
    struct Room
    {
        ...
        std::shared_ptr<GameServiceHandle> service_handle;
